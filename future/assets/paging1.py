...
class Page:
    ...
    def page_str(self):
        ...
        if self.current_page == 1:
            ...
            prev = '''
                <li class="paginate_button">
                    <a href="%s?p=%s" aria-controls="example2" data-dt-idx="0" tabindex="0">上一页</a>
                </li>
            ...
            if i == self.current_page:
                temp = '''
                    <li class="paginate_button active">
                        <a href="%s?p=%s" aria-controls="example2" data-dt-idx="0" tabindex="0">%s</a>
                    </li>
                ''' % (self.page_url, i, i)
            else:
                temp = '''
        ...
        if self.current_page == self.total_count:
            ...
            jump = '''
                <li class="paginate_button">
                    <a href="%s?p=%s" aria-controls="example2" data-dt-idx="0" tabindex="0">下一页</a>
                </li>
            ''' % (self.page_url, self.current_page + 1,)
